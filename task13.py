...
def forge_admin_ct() -> bytes:
    ...
    up_to_admin_block = enc_profile("maya@snarg.io")[:32]  # important that email=maya@snarg.io&uid=10&role= is aligned with block
...
if __name__ == "__main__":
    ...
    assert dec_profile(enc_profile("foo@bar.com")) == {'email': 'foo@bar.com', 'uid': '10', 'role': 'user'}
